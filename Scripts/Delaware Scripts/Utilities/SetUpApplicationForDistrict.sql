...
drop procedure [dbo].[SetUpApplicationForDistrict]
go
create procedure [dbo].[SetUpApplicationForDistrict] (@application varchar(25), @vendorname varchar(25),@districtId int, @seed varchar(10),@Name varchar(10), @UserId int ) as
 begin
	...
	select @seed, @Secret,@Name, 1, 0, 0, @ApplicationId,@UserId,'Active','',1,0
