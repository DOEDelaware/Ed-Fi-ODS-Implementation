...
values
  ...
  ('40','uri://doe.k12.de.us/AsessmentRoster','Alt ELA',getdate(),getdate()),
  ('30','uri://cambiumassessment.com/AsessmentRoster','Smarter Math',getdate(),getdate()),
  ('50','uri://doe.k12.de.us/AsessmentRoster','Alt Math',getdate(),getdate()),
  ('80','uri://cambiumassessment.com/AsessmentRoster','Science',getdate(),getdate()),
  ('60','uri://doe.k12.de.us/AsessmentRoster','Alt Science',getdate(),getdate()),
  ('70','uri://cambiumassessment.com/AsessmentRoster','Social Studies',getdate(),getdate()),
  ('85','uri://cambiumassessment.com/AsessmentRoster','Biology',getdate(),getdate()),
  ...
  ('160','uri://doe.k12.de.us/asessmentroster','EL first year',getdate(),getdate()),
  ('200','uri://doe.k12.de.us/AsessmentRoster','Science End of Unit - Elementary',getdate(),getdate()),
  ('210','uri://doe.k12.de.us/AsessmentRoster','Science End of Unit - High',getdate(),getdate())
