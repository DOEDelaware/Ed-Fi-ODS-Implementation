...
go
CREATE OR ALTER procedure  PopulateDescriptors ( @DescName varchar(255), @schma varchar(25)='edfi',@act varchar(1)='1', @source varchar(255)='DOE' ) as
/*
...
declare @nmspc nvarchar(100)
set @nmspc= 'uri://'' + sources.NameSpaceRoot + ''/' + @DescName + 'Descriptor'
...
--sk 4/6/2023 New Descriptors for 2023/24
PopulateDescriptors 'ChoiceBasis','de'
go
PopulateDescriptors 'HomelessProgramService','edfi'
go
PopulateDescriptors 'HomelessPrimaryNighttimeResidence','edfi'
go

--sk 5/6/2024 New Descriptors for 2024/25
PopulateDescriptors 'ProgramEvaluationType','de'
go
PopulateDescriptors 'ProgramEvaluationPeriod','de'
go
PopulateDescriptors 'Section504Disability','de'
go
PopulateDescriptors 'RatingLevel', 'de'
go


--sk Locale descriptor
PopulateDescriptors 'locale', 'edfi'
go
