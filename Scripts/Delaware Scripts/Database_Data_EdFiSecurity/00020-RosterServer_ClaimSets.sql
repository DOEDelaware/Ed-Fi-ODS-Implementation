...
INSERT INTO [dbo].[ResourceClaimAuthorizationMetadatas] ([Action_ActionId],[AuthorizationStrategy_AuthorizationStrategyId],[ResourceClaim_ResourceClaimId])       select 1             ,1             , (select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity')        where not exists (select * from [ResourceClaimAuthorizationMetadatas] where Action_ActionId=1 and [AuthorizationStrategy_AuthorizationStrategyId]=1 and [ResourceClaim_ResourceClaimId]=(select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity'))
INSERT INTO [dbo].[ResourceClaimAuthorizationMetadatas] ([Action_ActionId],[AuthorizationStrategy_AuthorizationStrategyId],[ResourceClaim_ResourceClaimId])       select 2             ,1             , (select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity')        where not exists (select * from [ResourceClaimAuthorizationMetadatas] where Action_ActionId=2 and [AuthorizationStrategy_AuthorizationStrategyId]=1 and [ResourceClaim_ResourceClaimId]=(select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity'))
INSERT INTO [dbo].[ResourceClaimAuthorizationMetadatas] ([Action_ActionId],[AuthorizationStrategy_AuthorizationStrategyId],[ResourceClaim_ResourceClaimId])       select 3             ,1             , (select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity')        where not exists (select * from [ResourceClaimAuthorizationMetadatas] where Action_ActionId=3 and [AuthorizationStrategy_AuthorizationStrategyId]=1 and [ResourceClaim_ResourceClaimId]=(select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity'))
INSERT INTO [dbo].[ResourceClaimAuthorizationMetadatas] ([Action_ActionId],[AuthorizationStrategy_AuthorizationStrategyId],[ResourceClaim_ResourceClaimId])       select 1             ,1             , (select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity')        where not exists (select * from [ResourceClaimAuthorizationMetadatas] where Action_ActionId=1 and [AuthorizationStrategy_AuthorizationStrategyId]=1 and [ResourceClaim_ResourceClaimId]=(select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity'))
INSERT INTO [dbo].[ResourceClaimAuthorizationMetadatas] ([Action_ActionId],[AuthorizationStrategy_AuthorizationStrategyId],[ResourceClaim_ResourceClaimId])       select 2             ,1             , (select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity')        where not exists (select * from [ResourceClaimAuthorizationMetadatas] where Action_ActionId=2 and [AuthorizationStrategy_AuthorizationStrategyId]=1 and [ResourceClaim_ResourceClaimId]=(select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity'))
INSERT INTO [dbo].[ResourceClaimAuthorizationMetadatas] ([Action_ActionId],[AuthorizationStrategy_AuthorizationStrategyId],[ResourceClaim_ResourceClaimId])       select 3             ,1             , (select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity')        where not exists (select * from [ResourceClaimAuthorizationMetadatas] where Action_ActionId=3 and [AuthorizationStrategy_AuthorizationStrategyId]=1 and [ResourceClaim_ResourceClaimId]=(select ResourceClaimId from ResourceClaims where ClaimName='http://ed-fi.org/ods/identity/claims/domains/identity'))