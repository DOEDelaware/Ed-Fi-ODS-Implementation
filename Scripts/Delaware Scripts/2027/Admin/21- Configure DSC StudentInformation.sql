...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCStudentInformation';
DECLARE @ClaimSetName NVARCHAR(255) = 'StudentInformation';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCStudentInformation';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_StudentInformation';
