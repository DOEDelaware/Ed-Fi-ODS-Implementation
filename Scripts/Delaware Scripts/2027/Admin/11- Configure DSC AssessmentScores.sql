...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCAssessmentScores';
DECLARE @ClaimSetName NVARCHAR(255) = 'AssessmentScores';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCAssessmentScores';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_AssessmentScores';
