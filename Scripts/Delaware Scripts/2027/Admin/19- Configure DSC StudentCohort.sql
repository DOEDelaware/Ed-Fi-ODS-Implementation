...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCCohort';
DECLARE @ClaimSetName NVARCHAR(255) = 'StudentCohort';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCCohort';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_Cohort';
