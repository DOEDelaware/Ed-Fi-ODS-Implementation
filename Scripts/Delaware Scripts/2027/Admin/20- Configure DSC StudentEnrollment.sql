...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCEnrollment';
DECLARE @ClaimSetName NVARCHAR(255) = 'StudentEnrollment';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCEnrollment';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_Enrollment';
