...
DECLARE @OdsInstanceConnectionString nvarchar(500) = 'server=doesisedfidb2\edfi;trusted_connection=True;database=EdFi_Delaware_ODS_2027;application name=EdFi.Ods.WebApi;Encrypt=False'
