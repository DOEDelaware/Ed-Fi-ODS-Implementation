...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCAttendance';
DECLARE @ClaimSetName NVARCHAR(255) = 'Attendance';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCAttendance';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_Attendance';
