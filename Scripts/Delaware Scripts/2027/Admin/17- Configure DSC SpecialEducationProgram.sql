...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCSpecialEducationProgram';
DECLARE @ClaimSetName NVARCHAR(255) = 'SpecialEducationProgram';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCSpecialEducationProgram';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_SpecialEducationProgram';
...
(9604),(9605),(9606),(9607),(9611),(9612),(9614); --,(9615) -- Removed: BASSE closed.
