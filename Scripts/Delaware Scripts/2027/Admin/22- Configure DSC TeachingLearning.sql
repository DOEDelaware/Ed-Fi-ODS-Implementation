...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCTeachingNLearning';
DECLARE @ClaimSetName NVARCHAR(255) = 'TeachingNLearning';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCTeachingNLearning';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_TeachingNLearning';
