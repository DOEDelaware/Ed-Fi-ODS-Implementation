...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCDiscipline';
DECLARE @ClaimSetName NVARCHAR(255) = 'Discipline';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCDiscipline';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_Discipline';
