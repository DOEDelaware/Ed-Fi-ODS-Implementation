...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCEnglishLearner';
DECLARE @ClaimSetName NVARCHAR(255) = 'EnglishLearner';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCEnglishLearner';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_EnglishLearner';
