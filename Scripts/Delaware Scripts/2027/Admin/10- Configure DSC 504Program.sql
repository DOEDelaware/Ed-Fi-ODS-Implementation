...
DECLARE @ApplicationName NVARCHAR(255) = 'DSC504Program';
DECLARE @ClaimSetName NVARCHAR(255) = '504Program';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSC504Program';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_504Program';
