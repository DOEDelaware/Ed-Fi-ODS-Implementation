...
DECLARE @ApplicationName NVARCHAR(255) = 'DSCGraduation';
DECLARE @ClaimSetName NVARCHAR(255) = 'Graduation';
DECLARE @ApiClientKey NVARCHAR(255) = 'DSCGraduation';
DECLARE @ApiClientName NVARCHAR(255) = 'DSC_Graduation';
