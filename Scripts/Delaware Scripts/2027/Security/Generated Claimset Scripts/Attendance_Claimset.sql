...
values ('Attendance', 0, 1)
go

insert into ClaimSetResourceClaimActions (ClaimSetId, ResourceClaimId, ActionId)
select
    (select ClaimSetId from ClaimSets where ClaimSetName = 'Attendance'),
...
from (values
    ...
    ('student', 2),
    ('student', 5),
    ('studentSchoolAttendanceEvent', 2),
    ('studentSchoolAttendanceEvent', 5),
    ('studentSectionAssociation', 2),
    ('studentSectionAssociation', 5),
    ('studentSectionAttendanceEvent', 2),
    ('studentSectionAttendanceEvent', 5),
    ('systemDescriptors', 2),
    ('systemDescriptors', 5),
    ('types', 2),
    ('types', 5)
