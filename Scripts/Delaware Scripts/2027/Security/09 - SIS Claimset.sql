...
insert into ClaimSets (ClaimSetName, IsEdfiPreset,ForApplicationUseOnly) values ( 'SIS',0,1)
go
...
INSERT INTO ClaimSetResourceClaimActions (ClaimSetId, ResourceClaimId, ActionId) select (select ClaimSetId from ClaimSets where  ClaimSetName='SIS'), (select ResourceClaimId from ResourceClaims where ResourceName='studentHealth'),1
INSERT INTO ClaimSetResourceClaimActions (ClaimSetId, ResourceClaimId, ActionId) select (select ClaimSetId from ClaimSets where  ClaimSetName='SIS'), (select ResourceClaimId from ResourceClaims where ResourceName='studentHealth'),2
INSERT INTO ClaimSetResourceClaimActions (ClaimSetId, ResourceClaimId, ActionId) select (select ClaimSetId from ClaimSets where  ClaimSetName='SIS'), (select ResourceClaimId from ResourceClaims where ResourceName='studentHealth'),3
INSERT INTO ClaimSetResourceClaimActions (ClaimSetId, ResourceClaimId, ActionId) select (select ClaimSetId from ClaimSets where  ClaimSetName='SIS'), (select ResourceClaimId from ResourceClaims where ResourceName='studentHealth'),4
