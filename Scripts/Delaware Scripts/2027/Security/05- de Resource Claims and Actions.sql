...
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'BirthMandateDescriptor', 'http://ed-fi.org/ods/identity/claims/BirthMandateDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'BullyingCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/BullyingCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'ChoiceBasisDescriptor', 'http://ed-fi.org/ods/identity/claims/ChoiceBasisDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'CTECertificationDescriptor', 'http://ed-fi.org/ods/identity/claims/CTECertificationDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'DeescalationTechniqueDescriptor', 'http://ed-fi.org/ods/identity/claims/DeescalationTechniqueDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'DiplomaCertificateCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/DiplomaCertificateCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'DisciplineActionPlacementTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/DisciplineActionPlacementTypeDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'FerpaOptOutDescriptor', 'http://ed-fi.org/ods/identity/claims/FerpaOptOutDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'FollowupCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/FollowupCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'FundingNeedsCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/FundingNeedsCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'HealthAlertCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/HealthAlertCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'IEPImplementationAfterThirdBirthdayReasonDescriptor', 'http://ed-fi.org/ods/identity/claims/IEPImplementationAfterThirdBirthdayReasonDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'IncidentRelatedToDescriptor', 'http://ed-fi.org/ods/identity/claims/IncidentRelatedToDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'LocationDescriptor', 'http://ed-fi.org/ods/identity/claims/LocationDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'MultiliteracyCertificateCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/MultiliteracyCertificateCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'NonViolentTechniqueDescriptor', 'http://ed-fi.org/ods/identity/claims/NonViolentTechniqueDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'NotificationMethodDescriptor', 'http://ed-fi.org/ods/identity/claims/NotificationMethodDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'OutOfTimelineReasonDescriptor', 'http://ed-fi.org/ods/identity/claims/OutOfTimelineReasonDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'ReasonForLateIEPDescriptor', 'http://ed-fi.org/ods/identity/claims/ReasonForLateIEPDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'RestraintEventCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/RestraintEventCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'SpecialEducationFundingDescriptor', 'http://ed-fi.org/ods/identity/claims/SpecialEducationFundingDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'SupportPlanChangeDescriptor', 'http://ed-fi.org/ods/identity/claims/SupportPlanChangeDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'TreatmentDescriptor', 'http://ed-fi.org/ods/identity/claims/TreatmentDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
