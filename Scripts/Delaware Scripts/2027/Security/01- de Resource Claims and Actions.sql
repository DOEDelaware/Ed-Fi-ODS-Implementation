...
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'AddressCharacteristicDescriptor', 'http://ed-fi.org/ods/identity/claims/de/AddressCharacteristicDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'AlternateCalendarProgramDescriptor', 'http://ed-fi.org/ods/identity/claims/de/AlternateCalendarProgramDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'ArrestInformationDescriptor', 'http://ed-fi.org/ods/identity/claims/de/ArrestInformationDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'BirthMandateDescriptor', 'http://ed-fi.org/ods/identity/claims/de/BirthMandateDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'BullyingCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/BullyingCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'ChoiceBasisDescriptor', 'http://ed-fi.org/ods/identity/claims/de/ChoiceBasisDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'CTECertificationDescriptor', 'http://ed-fi.org/ods/identity/claims/de/CTECertificationDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'DeescalationTechniqueDescriptor', 'http://ed-fi.org/ods/identity/claims/de/DeescalationTechniqueDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'DiplomaCertificateCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/DiplomaCertificateCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'DisciplineActionPlacementTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/de/DisciplineActionPlacementTypeDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'FerpaOptOutDescriptor', 'http://ed-fi.org/ods/identity/claims/de/FerpaOptOutDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'FollowupCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/FollowupCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'FundingNeedsCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/FundingNeedsCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'HealthAlertCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/HealthAlertCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'IEPImplementationAfterThirdBirthdayReasonDescriptor', 'http://ed-fi.org/ods/identity/claims/de/IEPImplementationAfterThirdBirthdayReasonDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'IncidentRelatedToDescriptor', 'http://ed-fi.org/ods/identity/claims/de/IncidentRelatedToDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'LocationDescriptor', 'http://ed-fi.org/ods/identity/claims/de/LocationDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'MultiliteracyCertificateCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/MultiliteracyCertificateCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'NonViolentTechniqueDescriptor', 'http://ed-fi.org/ods/identity/claims/de/NonViolentTechniqueDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'NotificationMethodDescriptor', 'http://ed-fi.org/ods/identity/claims/de/NotificationMethodDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'OutOfTimelineReasonDescriptor', 'http://ed-fi.org/ods/identity/claims/de/OutOfTimelineReasonDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'ReasonForLateIEPDescriptor', 'http://ed-fi.org/ods/identity/claims/de/ReasonForLateIEPDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'RestraintEventCategoryDescriptor', 'http://ed-fi.org/ods/identity/claims/de/RestraintEventCategoryDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'SpecialEducationFundingDescriptor', 'http://ed-fi.org/ods/identity/claims/de/SpecialEducationFundingDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'SupportPlanChangeDescriptor', 'http://ed-fi.org/ods/identity/claims/de/SupportPlanChangeDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
insert ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId) select 'TreatmentDescriptor', 'http://ed-fi.org/ods/identity/claims/de/TreatmentDescriptor',(select ResourceClaimId from ResourceClaims where ResourceName='systemDescriptors')
