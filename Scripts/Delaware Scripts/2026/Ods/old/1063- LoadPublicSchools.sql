...
from 
	CODELIBRARYSOURCE.codelibrary.dbo.School school 
		join CODELIBRARYSOURCE.codelibrary.dbo.Building building on school.schoolyear=building.schoolyear and school.districtcode=building.districtCode and school.schoolcode=building.schoolcode 
		join CODELIBRARYSOURCE.codelibrary.edorgs.BuildingGradeLevel grade on school.schoolcode = grade.schoolcode and school.schoolyear=grade.schoolyear 
		join edfi.Descriptor gradedesc on gradedesc.CodeValue = grade.GradeLEvelCode and Namespace='uri://doe.k12.de.us/GradeLevelDescriptor'
